...
for key in ["REFERENCE_DUMMY","ADVERSARIAL_CONFORMANT_DUMMY","STABLE_INTEGRATION_PLANE_REHEARSAL",
            "HOST_DURABLE_WRITE","HOST_PROCESS_RESTART_READ","HOST_SHARED_PRODUCT_REGISTRY","HOST_CORRUPTION_REJECTION",
...
evidence={"schemaVersion":1,"projectId":"ToolBox","stageId":"A","componentId":"public.stage-a-android-host","status":"PASS",
          ...
          "evidence":{"pureJvm":"PASS","api30EmulatorRuntime":"PASS","referenceDummy":"PASS","adversarialConformantDummy":"PASS",
                      "stableIntegrationPlaneRehearsal":"PASS","processRestartDurability":"PASS","sharedProductRegistry":"PASS","corruptionChallenge":"PASS",
...
print("ANDROID_HOST_STABLE_INTEGRATION_PLANE=PASS")
