...
for key in ["HOST_DURABLE_WRITE","HOST_PROCESS_RESTART_READ","HOST_CORRUPTION_REJECTION",
            "HOST_PERMISSION_PROVIDER","HOST_RESOURCE_MAPPING","HOST_SAFE_UI_RENDER"]:
...
evidence={"schemaVersion":1,"projectId":"ToolBox","stageId":"A","componentId":"public.stage-a-android-host","status":"PASS",
          ...
          "evidence":{"pureJvm":"PASS","api30EmulatorRuntime":"PASS","processRestartDurability":"PASS","corruptionChallenge":"PASS",
                      "permissionProvider":"PASS","resourceMapping":"PASS","safeUiRender":"PASS","mutation":"PASS"},
