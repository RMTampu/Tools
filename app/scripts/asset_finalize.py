...
pre=json.loads((OUT/"tahap4-asset-prebuild-evidence.json").read_text())
...
assert "TAHAP4_UI_TEXT=PASS" in runtime
...
(OUT/"tahap4-asset-final-evidence.json").write_text(
    json.dumps(evidence,indent=2,sort_keys=True)+"\n"
)
print("TAHAP_4_ASSET_SAFE_CHAIN = PASS")
