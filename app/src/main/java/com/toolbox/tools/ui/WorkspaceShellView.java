...
public final class WorkspaceShellView extends FrameLayout {
    ...
    private void resetPrimaryObject() {
        ...
        map.put("ui.object.home.primary.position.y.dp", "50");
        map.put("ui.object.home.primary.icon", "");
        map.put("ui.object.home.primary.icon.placement", "start");
        map.put("ui.object.home.primary.padding.dp", "12");
        map.put("ui.object.home.primary.padding.left.dp", "12");
        map.put("ui.object.home.primary.padding.top.dp", "6");
        map.put("ui.object.home.primary.padding.right.dp", "12");
        map.put("ui.object.home.primary.padding.bottom.dp", "6");
        map.put("ui.object.home.primary.margin.dp", "0");
        map.put("ui.object.home.primary.margin.left.dp", "0");
        map.put("ui.object.home.primary.margin.top.dp", "0");
        map.put("ui.object.home.primary.radius.dp", "14");
        map.put("ui.object.home.primary.radius.topleft.dp", "14");
        map.put("ui.object.home.primary.radius.topright.dp", "14");
        map.put("ui.object.home.primary.radius.bottomright.dp", "14");
        map.put("ui.object.home.primary.radius.bottomleft.dp", "14");
        map.put("ui.object.home.primary.border.dp", "1");
        map.put("ui.object.home.primary.border.color", "blue");
        map.put("ui.object.home.primary.text.size.sp", "13");
        map.put("ui.object.home.primary.text.weight", "600");
        map.put("ui.object.home.primary.text.italic", "false");
        map.put("ui.object.home.primary.text.letterspacing", "0");
        map.put("ui.object.home.primary.text.maxlines", "1");
        map.put("ui.object.home.primary.text.case", "normal");
        map.put("ui.object.home.primary.text.color", "background");
        ...
        map.put("ui.object.home.primary.scale.x", "1.0");
        map.put("ui.object.home.primary.scale.y", "1.0");
        map.put("ui.object.home.primary.flip.x", "false");
        map.put("ui.object.home.primary.flip.y", "false");
